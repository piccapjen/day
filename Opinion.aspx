<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Opinion.aspx.cs" Inherits="Opinion" %>
                    ...
                    <table  class="auto-style8">
                        ...
                        <tr>
                            ...
                            <td class="auto-style27" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000; border-left-style: solid; border-left-width: thin; border-left-color: #000000;"colspan="3"><strong>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Thesis plan review systemConnectionString %>" UpdateCommand="UPDATE Thesis_Plan SET Chinese_Topic = @Chinese_Topic WHERE (Student_ID = @ID)" OnSelecting="SqlDataSource1_Selecting" SelectCommand="select * from Thesis_Plan ">
                                    <UpdateParameters>
                        ...
                        <tr>
                            ...
                            <td class="auto-style24">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PaperConnectionString %>" SelectCommand="SELECT * FROM [db_user]" UpdateCommand="UPDATE Thesis_Plan SET Thesis_FileName = @Thesis_FileName  WHERE (Student_ID = @ID)">
                                    <UpdateParameters>
                                        <asp:SessionParameter Name="ID" SessionField="ID" />
                            ...
                            <td>
                                ...
                                <asp:Button ID="Button2" runat="server" ForeColor="Black" OnClick="Button2_Click" Text="Button" Visible="False" />
