<%@ Page Title="" Language="C#" MasterPageFile="MasterPage_Teacher.master" AutoEventWireup="true" CodeFile="Adviser_B.aspx.cs" Inherits="GuidingTeacher" %>
            ...
            <td class="auto-style8">
                <asp:GridView ID="GridView1" DataKeyNames ="Plan_Number" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Horizontal" Height="498px" Width="1060px"     >
                    <Columns>
                        ...
                        <asp:BoundField DataField="Chinese_Topic" HeaderText="論文標題" SortExpression="Chinese_Topic" />
                        <asp:TemplateField HeaderText="檔案下載" SortExpression="Thesis_FileName">
                            <EditItemTemplate>
