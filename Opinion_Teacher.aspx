<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Teacher.master" AutoEventWireup="true" CodeFile="Opinion_Teacher.aspx.cs" Inherits="Opinion" %>
                ...
                <td class="auto-style10" style="border: thin solid #000000">
                    <table  class="auto-style8">
                        ...
                        <tr>
                            ...
                            <td class="auto-style27" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000; border-left-style: solid; border-left-width: thin; border-left-color: #000000;"colspan="2"><strong>
                                <asp:Label ID="Label_ThesisTopic1" runat="server" CssClass="auto-style18" ForeColor="Black"></asp:Label>
