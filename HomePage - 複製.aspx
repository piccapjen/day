<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomePage - 複製.aspx.cs" Inherits="HomePage" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                ...
                <div class="navbar-collapse collapse">							
					<div class="menu">
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation"><a href="Login.aspx" >登入</a></li>
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">						
						...
						<div class="auto-style1" style="background-color: #3399FF">
						</div>
				    </div>
